...
>(
  ...
  useMemo(() => {
    ...
    const styleSource = {} as any as CSSProperties;
...
>(
  ...
  outStyleSource?: CSSProperties,
) {
  const sp = outStyleProps as Writable<TStyleProps> | undefined;
  const ss = outStyleSource as Writable<CSSProperties> | undefined;
      ...
      switch (key) {
        ...
        case "paddingVertical":
          ...
          if (ss && paddingVertical !== undefined) {
            ss.padding = `${paddingVertical}px 0`;
          }
          break;
        case "paddingHorizontal":
          ...
          if (ss && paddingHorizontal !== undefined) {
            ss.padding = `0 ${paddingHorizontal}px`;
          }
          break;
        case "padding":
        ...
        // shadow
        case "box-shadow":
          const bsh: FlexProps["boxShadow"] = v;
